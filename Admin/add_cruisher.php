...
<div class="btn btn-warning"><a href="index.php">Go Back</a></div>
 <body>
 	<form id="transaction" method="post" action="db_save_cruisher.php">
 	<pre>
 		Cruisher Name :		<input type="text" name="name" id="name" required><br>
 		Address :		<input type="text" name="address" id="address" ><br>
 		Products :		<input type="text" name="Products" id="Products" required><br>
 		Phone :			<input type="text" name="phone" id="phone" pattern="[0-9]+" required><br>
